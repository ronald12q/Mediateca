...
public class menuPrincipal extends javax.swing.JPanel {
    ...
    private void BtnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBorrarActionPerformed
        ...
        JFrame eliminarWindow = new JFrame("Eliminar");
        eliminarWindow.setLayout(new BorderLayout());
        eliminarWindow.add(eliminar);
        eliminarWindow.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        eliminarWindow.setVisible(true);
        eliminarWindow.setLocationRelativeTo(null);
               
        eliminarWindow.pack();
    }//GEN-LAST:event_BtnBorrarActionPerformed

    private void BtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModificarActionPerformed
        modificarMaterial eliminar = new modificarMaterial();
        JFrame modificarWindow = new JFrame("Modificar");
        modificarWindow.setLayout(new BorderLayout());
        modificarWindow.add(eliminar);
